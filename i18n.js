...
(function () {
  ...
  const DICT = {
    ru: {
      ...
      home_row_pro_title: "PRIME Pro",
      home_row_pro_sub: "Разбор по метрикам + безлимит",
      home_mini_text: "Фото → score → Elo → музыка → советы. Данные сохраняются отдельно для каждого Telegram-аккаунта.",
      back: "‹ Назад",

      pro_eyebrow: "PRIME PRO",
      pro_title: "PRIME Pro",
      pro_sub: "Разблокируй полный разбор своей внешности и безлимит по фичам.",
      pro_status_loading: "Проверяем статус…",
      pro_status_free: "Сейчас у тебя бесплатная версия",
      pro_status_active: (date) => `Pro активен до ${date}`,
      pro_status_lifetime: "У тебя PRIME Pro навсегда 👑",
      pro_benefit_1: "🔎 Полный разбор по всем 6 метрикам + что делать на этой неделе",
      pro_benefit_2: (limit) => `♾️ Безлимит батлов сравнения (бесплатно — ${limit}/день)`,
      pro_benefit_3: "👑 Отметка PRO в профиле",
      pro_price_label: (stars, days) => `${stars} ⭐ / ${days} дней`,
      pro_buy_btn: "Оформить PRIME Pro",
      pro_buy_btn_renew: "Продлить PRIME Pro",
      pro_lifetime_divider: "Или разово, без подписки",
      pro_price_lifetime_label: (stars) => `${stars} ⭐ — один раз, навсегда`,
      pro_buy_lifetime_btn: "PRIME Pro навсегда",
      pro_buy_pending: "Открываем оплату…",
      pro_buy_failed: (msg) => `Не удалось открыть оплату: ${msg}`,
      pro_buy_success: "PRIME Pro активирован 🎉",
      pro_buy_cancelled: "Оплата отменена",
      referral_title: "Пригласи друзей",
      referral_sub: "Своя ссылка — переходы и регистрации по ней видно в статистике.",
      referral_loading: "Загружаем…",
      referral_not_ready: "Ссылка пока не настроена — попроси разработчика включить её на сервере.",
      referral_copy_btn: "Скопировать ссылку",
      referral_copied: "Ссылка скопирована",
      referral_copy_failed: "Не удалось скопировать",
      advice_locked_title: "🔒 Разбор доступен в PRIME Pro",
      advice_locked_text: "Конкретные советы по каждой метрике — что именно делать на этой неделе — открываются с подпиской.",
      advice_locked_btn: "Разблокировать",
      ...
      compare_locked_status: (limit) => `Бесплатный лимит батлов исчерпан (${limit}/день). Нужен PRIME Pro для безлимита.`,
      compare_locked_toast: "Лимит батлов исчерпан — нужен PRIME Pro",
    ...
    en: {
      ...
      home_row_pro_title: "PRIME Pro",
      home_row_pro_sub: "Full breakdown + unlimited",
      home_mini_text: "Photo → score → Elo → music → advice. Data is saved separately for every Telegram account.",
      back: "‹ Back",

      pro_eyebrow: "PRIME PRO",
      pro_title: "PRIME Pro",
      pro_sub: "Unlock the full breakdown of your looks and unlimited use of every feature.",
      pro_status_loading: "Checking status…",
      pro_status_free: "You're on the free plan right now",
      pro_status_active: (date) => `Pro active until ${date}`,
      pro_status_lifetime: "You have PRIME Pro forever 👑",
      pro_benefit_1: "🔎 Full breakdown of all 6 metrics + exactly what to do this week",
      pro_benefit_2: (limit) => `♾️ Unlimited face battles (free tier — ${limit}/day)`,
      pro_benefit_3: "👑 PRO badge on your profile",
      pro_price_label: (stars, days) => `${stars} ⭐ / ${days} days`,
      pro_buy_btn: "Get PRIME Pro",
      pro_buy_btn_renew: "Renew PRIME Pro",
      pro_lifetime_divider: "Or pay once, no subscription",
      pro_price_lifetime_label: (stars) => `${stars} ⭐ — one time, forever`,
      pro_buy_lifetime_btn: "PRIME Pro forever",
      pro_buy_pending: "Opening checkout…",
      pro_buy_failed: (msg) => `Couldn't open checkout: ${msg}`,
      pro_buy_success: "PRIME Pro activated 🎉",
      pro_buy_cancelled: "Payment cancelled",
      referral_title: "Invite friends",
      referral_sub: "Your personal link — its visits and signups show up in analytics.",
      referral_loading: "Loading…",
      referral_not_ready: "Link isn't set up yet — ask the developer to enable it on the server.",
      referral_copy_btn: "Copy link",
      referral_copied: "Link copied",
      referral_copy_failed: "Couldn't copy",
      advice_locked_title: "🔒 Breakdown available in PRIME Pro",
      advice_locked_text: "Specific advice for each metric — exactly what to do this week — unlocks with a subscription.",
      advice_locked_btn: "Unlock",
      face_eyebrow: "FACE ANALYSIS",
      ...
      compare_locked_status: (limit) => `Free daily battle limit reached (${limit}/day). Get PRIME Pro for unlimited.`,
      compare_locked_toast: "Battle limit reached — get PRIME Pro",
